...
| rm_trung | 123456 | Manager |
| coord_hue | 123456 | Coordinator |
| leader_hue1 | 123456 | Rescue Team |
| member1 | 123456 | Rescue Team |
      ...
      schemas: {
        ...
        User: {
          ...
          properties: {
            ...
            role: {
              type: "string",
              enum: ["admin", "manager", "coordinator", "rescue_team"],
            },
    ...
    paths: {
      ...
      "/dashboard/response-time": {
        get: {
          tags: ["Dashboard"],
          summary: "Thống kê thời gian phản hồi",
          security: [{ bearerAuth: [] }],
          responses: { 200: { description: "Avg, min, max response time" } },
        },
      },
